...
namespace StockFlow.Application.Interfaces.Inventory
{
    ...
    {
        Task<StockMovementResponseDto> RegisterEntryAsync(
            CreateStockMovementDto dto);

        Task<StockMovementResponseDto> RegisterExitAsync(
            CreateStockMovementDto dto);

        Task<StockMovementResponseDto> RegisterAdjustmentAsync(
            CreateStockMovementDto dto);

        Task<StockMovementResponseDto> GetByIdAsync(
            int id);

        Task<IEnumerable<StockMovementResponseDto>> GetAllAsync();

        Task<IEnumerable<StockMovementResponseDto>>
