...
using StockFlow.Infrastructure.Services.Export;
...
namespace StockFlow.Application.Services
{
    public class ReportService : IReportService
    {
        ...
        public async Task<IEnumerable<StockMovementReportDto>> GetStockMovementReportAsync(CustomerSalesReportDto queryParameters)
        {
        ...
        public async Task<byte[]> ExportCurrentStockCsvAsync()
        {
            ...
            return CsvExportService.ExportToCsv(data);
        }
        ...
        public async Task<byte[]> ExportCurrentStockExcelAsync()
        {
            ...
            return ExcelExportService.ExportToExcel(data, "CurrentStock");
        }

        public async Task<byte[]> ExportStockMovementsCsvAsync(CustomerSalesReportDto query)
        {
        ...
        public async Task<byte[]> ExportStockMovementsExcelAsync(CustomerSalesReportDto query)
        {
            var data = await GetStockMovementReportAsync(query);
            ...
            return ExcelExportService.ExportToExcel(data, "StockMovements");
        }
    }
}