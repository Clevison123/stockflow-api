...
namespace StockFlow.API.src.Presentation.Controllers
{
    ...
    public class ReportsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetStockMovementReport([FromQuery] CustomerSalesReportDto queryParameters)
        {
        ...
        public async Task<IActionResult> ExportStockMovementsCsv([FromQuery] CustomerSalesReportDto query)
        {
        ...
        public async Task<IActionResult> ExportStockMovementsExcel([FromQuery] CustomerSalesReportDto query)
        {
